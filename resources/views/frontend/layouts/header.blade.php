...
<head>
  ...
  <meta name="keywords" content="&lt;?php echo e(); ?&gt;">

  
  <meta name="csrf-token" content="PAFiYWeyC0ujPSMDJv9UwYfvE7TFY6wFAavxcATM">
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
  ...
  <!-- Icomoon Icon CSS -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/fonts/icomoon/style.css">
  <!-- Date-range Picker -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/css/vendors/daterangepicker.css">
  <!-- Magnific Popup CSS -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/css/vendors/magnific-popup.min.css">
  <!-- Swiper Slider -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/css/vendors/swiper-bundle.min.css">
  <!-- Nice Select -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/css/vendors/nice-select.css">
  <!-- AOS Animation CSS -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/css/vendors/aos.min.css">
  <!-- Animate CSS -->
  <link rel="stylesheet" href="https://codecanyon8.kreativdev.com/hotelia/demo/front/theme_four/assets/css/vendors/animate.min.css">
  <!-- Main Style CSS -->
...
<div class="main-responsive-nav">
  <div class="container">
    ...
    <div class="logo">
      <a href="{{url('/')}}">
        <img src="{{asset('uploads/frontend/logo.jpg')}}" alt="logo" width="64%">
      </a>
    </div>
    <!-- Menu toggle button -->
    ...
    <div class="row align-items-center">
        <div class="col-sm-6 col-md-7 col-lg-6">
            ...
            <ul class="list-unstyled d-flex align-items-center gap-3">
                    ...
                    <a target="_self" title="West Dhangmari, Banishanta, Dacope, Khulna, Bangladesh">
                    Khulna, Bangladesh
                    </a>
                </li>
                                                <li class="icon-start">
                    <a href="tel:01991505070" target="_self">
                    <i class="fas fa-user-headset"></i>01991505070
                    </a>
                </li>
                            </ul>
            </div>
   ...
   <div class="container">
    <div class="main-navbar">
     <nav class="navbar navbar-expand-lg">
       <a class="navbar-brand" href="{{url('/')}}" target="_self" title="Link">
         <img style="height: 100px;width: 100px" src="{{asset('uploads/frontend/logo.jpg')}}" alt="website logo" >
       </a>
       <!-- Navigation items -->
         ...
         <ul id="mainMenu" class="navbar-nav mobile-item mx-auto">
                 ...
                 <li class="nav-item mx-xl-1"><a href="{{url('/')}}" target="_self"
                 ...
                 <li class="nav-item mx-xl-1"><a href="{{url('/services')}}" target="_self"
                 ...
                 <li class="nav-item mx-xl-1"><a href="{{url('contact')}}" target="_self"
           ...
           <form action="https://codecanyon8.kreativdev.com/hotelia/demo/change_language" method="GET">
             <!-- <div class="language">
               <select class="niceselect" name="lang_code" onchange="this.form.submit()">
                    ...
                    <div class="item">
             <a href="{{route('login')}}" class="btn btn-md btn-primary rounded-pill" title="Login" target="_self">LogIn</a>
           </div>
                </div>
     </nav>
   </div>
