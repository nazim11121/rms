    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item"><a href="#">Food Management</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">Dining</a></li>
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-light">
                        <h4 class="mb-0">Edit Dining Order</h4>
                    </div>
                    <div class="card-body">
                        @csrf
                        <h1>Food Cart</h1>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <div class="cart">
                                    <h2>Cart for <span id="customer-name">{{ $customer->name }}</span></h2>
                                    <div class="cart-items" id="cart-items"></div>
                                    <div class="total">Total: $<span id="cart-total">0.00</span></div>
                                    <button id="update-cart" style="margin-top: 20px; padding: 10px 20px; background: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer;">
                                        Update
                                    </button>
                                </div>
                            </div>
...
// Preload cart for the customer from Blade
const carts = {
    "{{ $customer->id }}": @json(collect($cart)->keyBy('id'))
};
...
document.getElementById('update-cart').addEventListener('click', () => {
    ...
    const payload = {
        ...
        cart: Object.values(cart).map(({ id, price, qty }) => ({
            id,
            price,
            qty,
            subtotal: price * qty
    ...
    fetch('{{ route("admin.food-management.dining.update", $customer->id) }}', {
        method: 'PATCH',
        headers: {
